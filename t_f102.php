...
<body>
    ...
    <center><b>FOLMULIR PENDAFTARAN PERISTIWA KEPENDUDUKAN</b></center></div>
    <br>
        ...
        <tr>
            ...
            <td valign="top" width="1%">
                ...
                <div class="huruf">
                    ...
                    <img src="img/centang.png" class="img" alt="l" width="30px">
                </div>
                <?php } else { ?>
                -
                <?php } ?>
