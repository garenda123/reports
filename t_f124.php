...
$query2 = "
SELECT * FROM t_f124 where penduduk_detail_id = $penduduk_detail_id
...
<body>
    ...
    <table width="10%" border="1" align="right" class="table-collapse">
        <tr>
            <td>
                <div align="center"><strong>F-1.24</strong></div>
            </td>
        </tr>
    </table>
    <br><br>
    ...
    <p align="center">SURAT KETERANGAN PINDAH DATANG WNI</p>
