...
<head>
    <title>FOLMULIR PERMOHONAN PINDAH DATANG WNI</title>
    <style>
    body {
        font-size: 13px;
    }
...
<body>
    ...
    <?php if ($ttd['klasifikasi'] == 1) { ?>
        <tr>
            <td width="30%">
            <div align="center"><strong>F-1.23</strong></div>
        ...
        <tr>
            <td>
                <div align="center"><strong>F-1.27</strong></div>
        ...
        <tr>
            ...
            <div align="center"><strong>F-1.31</strong></div>
                         </td>
            </td>
        ...
        <tr>
            ...
            <div align="center"><strong>F-1.38</strong></div>
                           </td>
            </td>
    ...
    <p align="center">FOLMULIR PERMOHONAN PINDAH DATANG WNI</p></div>
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <td colspan="6">DATA DAERAH ASAL</td>
        </tr>
        <tr>
           
            <td width="1%">1. </td>
            <td width="13%">Nomor Kartu Keluarga</td>
            <td width="1%">:</td>
            <td width="30%"><?php echo $ttd['no_kk_asal']; ?></td>
            <td></td>
            <td></td>
        </tr>
        <tr>
