...
<body>
    ...
    <center><b>SURAT KUASA PENGISIAN BIODATA PENDUDUK<br>
WARGA NEGARA INDONESIA</b></center>
  <br>
  
   <p>Pada hari ini tanggal Bulan tahun 
bertempat di Kabupaten Banyumas, saya :</p>
   <table width="100%" border="0">
        ...
        <tr>
            ...
            <td>:</td>
            <td><?php echo $ttd['tempat_lhr_1']; ?>  <?php echo $ttd['tgl_lhr_1']; ?></td>
        </tr>
        <tr>
            <td></td>
            <td> </td>
    ...
    <tr>
        ...
        <td>Tempat/Tgl Lahir/Umur</td>
        <td>:</td>
        <td><?php echo $ttd['tempat_lhr_2']; ?> <?php echo $ttd['tgl_lhr_2']; ?></td>
    </tr>
    <tr>
        <td></td>
        <td> </td>
...
<br>  <?php echo tanggal($ttd['tgl_entri']); ?><br>
