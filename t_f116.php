...
LEFT OUTER JOIN t_f116 c ON a.penduduk_detail_id = c.penduduk_detail_id
...
<head>
    <title>FORMULIR PERMOHONAN PERUBAHAN KARTU KELUARGA (KK) BARU</title>
    <style>
    body {
        font-size: 13px;
    }
...
<body>
    ...
    <table width="10%" border="1" align="right" class="table-collapse">
        <tr>
            <td>
                <div align="center"><strong>F-1.16</strong></div>
            </td>
        </tr>
    </table>

    <div style="font-size:18px">&nbsp;
    <center><b>FORMULIR PERMOHONAN PERUBAHAN KARTU KELUARGA (KK)<br>
...
<table width="100%" border="0">
              <tr>
                ...
                <td width="4%">&nbsp;</td>
                <td>RT: <?php echo $hasil['rt']; ?></td>
                <td class="kotak"></td>
                <td width="3%">RW: <?php echo $hasil['rw']; ?></td>
              ...
              <tr>
                ...
                <td colspan="2" class="kotak"><?php echo $hasil['pemohon_kel']; ?></td>
                <td width="3%">&nbsp;</td>
                <td width="14%">b. Kecamatan</td>
                <td colspan="2" class="kotak"><?php echo $hasil['pemohon_kec']; ?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>c. Kabupaten/Kota</td>
                <td colspan="2" class="kotak"><?php echo $hasil['pemohon_kab']; ?></td>
                <td>&nbsp;</td>
                <td>d. Propinsi</td>
                <td colspan="2" class="kotak"> <?php echo $hasil['pemohon_prop']; ?> </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td width="95%"> 1.Karena Membentuk Keluarga Baru</td>
        </tr>
        <tr>
            <td>
                <table width="100%" border="1" class="table-collapse">
...
<table width="100%" border="0">
      ...
      <table width="100%"  border="0">
                ...
                <tr>
                  <td colspan="4"><div align="center">Mengetahui : </div></td>
                </tr>
                <tr>
                  <td width="25%"><p align="center">Kepala Dinas Kependudukan<br>
                    dan Pencatatan Sipil<br> Kabupaten Banyumas</p>
                    <p align="center">&nbsp;</p>
                    <p align="center">......................................<br>
                    NIP.............................  </p>    </td>
                  <td width="25%"><p align="center">Camat</p>
                    <p align="center">&nbsp;</p>
                    <p align="center">......................................<br>
                  NIP............................</p></td>
                  ...
                  <td width="24%"><p align="center">Karantalun kidul</p>
