...
$query2 = "
SELECT *, m.agama as agama FROM t_pindah_ulang as z
...
FROM m_penduduk_detail as a
-- LEFT OUTER JOIN m_penduduk b ON a.nik = b.nik
LEFT OUTER JOIN t_pindah_ulang c ON a.penduduk_detail_id = c.penduduk_detail_id
...
<head>
    <title>SURAT PERNYATAAN PINDAH ULANG</title>
    <style>
    body {
        font-size: 13px;
    }
...
<div style="font-size:18px">&nbsp;
    <center><b>SURAT PERNYATAAN BATAL PINDAH ULANG</b></center></div>
   ...
   <table width="100%" border="0">
        ...
        <tr>
            ...
            <td>:</td>
            <td><?php echo $hasil['pemohon_tmpt_lhr']." / ".tanggal($hasil['pemohon_tgl_lhr']); ?></td>
        </tr>
        <tr>
            <td></td>
            <td></td>
        ...
        <tr>
            ...
            <td>:</td>
            <td><?php echo $hasil['pemohon_shdk']; ?></td>
...
<table width="100%"  border="0">
            ...
            <tr>
              ...
              <td width="40%" bordercolor="#000000"><p align="center">Kabupaten Banyumas, <?php echo tanggal($hasil['tgl_entri']); ?></p>
                <p align="center">Yang Membuat Pernyataan,<br> <br>Materai<br>
Rp: 6000   </p>
        
                <p align="center">&nbsp;</p>
                <p align="center"><u>(<?php echo $hasil['nama_pemohon']; ?>)</u><br>
                </p></td>
            </tr>
          </table>
          <table width="100%"  border="0">
              ...
              <tr>
                ...
                <td width="28%"><p align="center">Camat <?php echo ucwords(strtolower($hasil['camat_nama'])); ?></p>
                  <p align="center">&nbsp;</p>
                  <p align="center">_____________________________________<br>
                 </p>    </td>
              </tr>
